export enum IntroductionEnum {
    ...
    InternationalTitle = 'International Mobility',
    InternationalDescription = '',

    SustainabilityTitle = 'Sustainability & Civic Engagement',
    SustainabilityDescription = '',

    HobbiesTitle = 'Hobbies',
    HobbiesDescription = 'Outside working hours, I engage in various activities that keep me open-minded, help me acquire new skills and allow me to develop them through diverse associations.',
